...
impl StorageBackend for BackfillStorageWrapper {
    ...
    fn archive_edges_for_entity(&self, _entity_id: &str, _superseded_at_sha: &str) -> Result<u64> {
        Ok(0)
    }
    ...
    fn archive_blocks_for_entity(&self, _entity_id: &str, _superseded_at_sha: &str) -> Result<u64> {
        Ok(0)
    }
    ...
    fn archive_themes_for_corpus(&self, _corpus_id: &str, _superseded_at_sha: &str) -> Result<u64> {
        Ok(0)
    }
